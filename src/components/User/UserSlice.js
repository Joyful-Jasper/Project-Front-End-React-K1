...
export const addUsersApi = createAsyncThunk("application/json", async (data) => {
	return await api.post("/users/", data).then((res) => console.log(res));
});

export const addBooks = createAsyncThunk("user/addBooks", async (data) => {
	return await api.post(`/borrow/`, data).then((res) => console.log(res));
});
